...
(defvar erl-int-bifs-face 'font-lock-builtin-face)
(defvar erl-ext-bifs-face 'font-lock-builtin-face)
(defvar erl-int-function-calls-face 'font-lock-type-face)
(defvar erl-ext-function-calls-face 'font-lock-type-face)
(defvar erl-fun-n-face 'font-lock-type-face)
(defvar erl-operators-face 'font-lock-builtin-face)
...
(defvar erl-keywords-face 'font-lock-keyword-face)
(defvar erl-attr-face 'font-lock-preprocessor-face)
(defvar erl-quotes-face 'font-lock-keyword-face)
(defvar erl-guards-face 'font-lock-builtin-face)
(defvar erl-predefined-types-face 'font-lock-builtin-face)
(defvar erl-macros-face 'font-lock-type-face)
(defvar erl-records-face 'font-lock-type-face)
(defvar erl-vars-face 'font-lock-variable-name-face)
...
(defvar erlang-font-lock-keywords-ext-function-calls
  (list
   (list (concat erlang-atom-regexp "\\s-*:\\s-*"
         ...
         '(1 erl-ext-function-calls-face)
	 '(2 erl-ext-function-calls-face)))
