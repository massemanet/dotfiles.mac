(defun color-theme-masse ()
  ...
  (color-theme-install
   '(color-theme-masse
     ...
     (ediff-current-diff-B ((((class color) (min-colors 16))
                             (:background "Yellow" :foreground "black"))))
     (ediff-even-diff-B ((((class color) (min-colors 16))
                          (:background "Grey" :foreground "black"))))
     (ediff-odd-diff-A ((((class color) (min-colors 16))
                         (:background "Grey" :foreground "black"))))
     ...
     (isearch-fail ((((class color) (min-colors 88)
                      (background light)) (:background "RosyBrown4"))))
     ...
     (magit-diff-add ((((class color) (background light))
                       (:foreground "green3"))))
     ...
     (mode-line ((((class color) (min-colors 88))
                  (:stipple nil :background "red1" :foreground "black"
                            :box (:line-width -1 :style released-button)))))
     (mode-line-buffer-id ((t (:background "color-94" :foreground "white"))))
     (mode-line-inactive ((t (:inherit mode-line :background "color-52"
